...
| `src/api/` | Results API + operator console (FastAPI + Svelte 5 SPA at `/app`). Router: `src/api/console.py` (8 REST endpoints + WebSocket `/console/ws`). Frontend: `src/api/frontend/` (Vite build → `src/api/static/dist/`). |
