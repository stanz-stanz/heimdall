...
| `Makefile` | Mac dev ergonomics. Lifecycle, seed, tests, `dev-ops-smoke`, `dev-cert-dry-run`, `dev-interpret-dry-run`. See `docs/development.md`. |
