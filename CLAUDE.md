...
| `scripts/test_telegram_e2e.py` | Automated E2E Telegram test using Telethon — sends message with buttons, receives via user client, clicks buttons, verifies response. Dev dependency: `telethon`. First run requires interactive auth. |
