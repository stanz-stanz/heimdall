---
name: devops
description: "Heimdall DevOps: Docker, systemd, cron, env vars, scan schedule, Tailscale VPN, log rotation, monitoring, Pi to cloud migration, secrets, deploy/backup scripts. Use for any infra-config or operational tooling task."
---
